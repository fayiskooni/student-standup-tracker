  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8"><div className="skeleton h-10 w-64" /></div>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-2">
          {(["7", "30", "all"] as DateRange[]).map((range) => (
            <button key={range} onClick={() => setDateRange(range)}
              className={`rounded-pill px-4 py-2 text-sm font-medium transition-all ${dateRange === range ? "bg-mentrex-primary text-white" : "bg-mentrex-elevated text-mentrex-text-secondary hover:text-white"}`}>
      ...
      <div className="rounded-card border border-mentrex bg-mentrex-card overflow-hidden">
        <div className="border-b border-mentrex px-5 py-4">
